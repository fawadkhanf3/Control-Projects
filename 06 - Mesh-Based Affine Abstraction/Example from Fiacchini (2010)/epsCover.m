...
if(error>des_error)
    ...
    cell_5 = epsCover(sub_bounds{5},param);
    cell_6 = epsCover(sub_bounds{6},param);
    ...
    size_f = s_1+s_2+s_3+s_4+s_5+s_6;
    ...
    for i = 1:s_5
        hyperplanes{k,1} = cell_5{i,1};
        k = k+1;
    end
    for i = 1:s_6
        hyperplanes{k,1} = cell_6{i,1};
        k = k+1;
    end
